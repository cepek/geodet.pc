...
C    A      - jednorozmerne pole s prvky typu REAL; pred vyvolanim    *
C             procedury musi byt v poli A po radcich ulozena dolni    *
C             trojuhelnikova cast dane matice A; pri vystupu z proce- *
C             dury bude ve stejnem prostoru analogicky ulozena dolni  *
C             trojuhelnikova cast inverzni matice                     *
C PRACOVNI  POLE:                                                     *
