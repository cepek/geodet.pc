...
C DATUM: 1989-06-30                                                   *
C * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
        SUBROUTINE MTFUNA (X,Y,M,K,A,QA,V,QL,DELVV,M0,F,IER)
	DOUBLE PRECISION X(1),Y(1),A(1),QA(1),V(1),QL(1),DELVV(1),M0
	INTEGER          M,K,IER
	REAL             F
C * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
...
C PREHLED PARAMETRU                                                   *
C VSTUPNI PARAMETRY:                                                  *
C    X      - pole, zpravidla jednorozmerne, s prvky typu REAL * 8    *
C             pro ulozeni hodnot argumentu                            *
...
C * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
C-
	DOUBLE PRECISION P(400),C(42),B(20),ALFA(20),BETA(20)
        DOUBLE PRECISION SP2,SP2MIN,SXP2,ALF,BET,SYP,PJ,P2
        DOUBLE PRECISION BI,CJ,VV
	INTEGER P0,P1,C0,C1
C	
	IER=1
	M1=M
